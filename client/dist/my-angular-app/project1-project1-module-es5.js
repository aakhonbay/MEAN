...
var FindComponent = /** @class */ (function () {
    ...
    FindComponent.prototype.showGroups = function () {
        this.groups = true;
    };
    FindComponent.prototype.showCalendar = function () {
        this.groups = false;
    };
...
var GroupsComponent = /** @class */ (function () {
    function GroupsComponent(service) {
        this.service = service;
    }
    GroupsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.service.getGroups().subscribe(function (res) {
...
var GroupPageComponent = /** @class */ (function () {
    function GroupPageComponent(route, service) {
        this.route = route;
        this.service = service;
    }
    GroupPageComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.paramMap.subscribe(function (observer) {
            _this.groupId = observer.get('id');
        });
        this.service.getGroupById(this.groupId).subscribe(function (res) {
            _this.groupAPI = res.groups;
            _this.events = _this.groupAPI.events;
        });
    };
    GroupPageComponent.ctorParameters = function () { return [
...
var GroupShellComponent = /** @class */ (function () {
    function GroupShellComponent() {
    }
    GroupShellComponent.prototype.ngOnInit = function () {
    };
...
var Project1RoutingModule = /** @class */ (function () {
    function Project1RoutingModule() {
    }
...
var Project1Module = /** @class */ (function () {
    function Project1Module() {
    }
...
var Project1Component = /** @class */ (function () {
    function Project1Component(_authService) {
    ...
    Project1Component.ctorParameters = function () { return [
...
var StartGroupComponent = /** @class */ (function () {
    function StartGroupComponent(http, router) {
        this.http = http;
        this.router = router;
    ...
    StartGroupComponent.prototype.onStartFormSubmit = function () {
        var _this = this;
        var group = {
        ...
        this.http.post('/api/groups/', group).subscribe(function (res) {
            if (res.message == 'Success') {
                console.log(res);
                _this.router.navigate(['/project1/find']);
            }
            else {
                _this.router.navigate(['/project1/start']);
            }
        }, function (err) { return console.log(err); });
    };
    StartGroupComponent.prototype.ngOnInit = function () {
    };
    StartGroupComponent.ctorParameters = function () { return [
...
var TaskDetailsGuard = /** @class */ (function () {
    function TaskDetailsGuard(tasksService, router) {
        this.tasksService = tasksService;
        this.router = router;
    }
    TaskDetailsGuard.prototype.canActivate = function (route, state) {
        var taskExists = !!this.tasksService.getById(route.paramMap.get('id'));
        if (!taskExists) {
            return false;
        }
        else {
    ...
    TaskDetailsGuard.ctorParameters = function () { return [
        { type: _tasks_api_service__WEBPACK_IMPORTED_MODULE_3__["TasksApiService"] },
...
var CreateTaskComponent = /** @class */ (function () {
    function CreateTaskComponent(_httpService) {
    ...
    // }
    CreateTaskComponent.prototype.onCreateSubmit = function () {
        var _this = this;
        var taskInput = {
        ...
        var task = { title: taskInput.title, description: taskInput.description, completed: taskInput.completed };
        this._httpService.createTask(task).subscribe(function (data) {
            console.log(data);
            _this.taskAdded.emit(data);
            _this.form.reset();
            _this.titleField.nativeElement.focus();
        });
    };
...
var ShowTaskComponent = /** @class */ (function () {
    function ShowTaskComponent(_httpService, route, router) {
        this._httpService = _httpService;
        this.route = route;
        this.router = router;
    }
    ShowTaskComponent.prototype.ngOnInit = function () {
        ...
        this.route.paramMap.subscribe(function (params) {
            _this._httpService.getById(params.get('id')).subscribe(function (data) {
                console.log("component:", data);
                _this.task = data;
            }, function (error) {
                console.log('fake id');
                // this.router.navigate(['/'])
                _this.router.navigate(['project1/tasks']);
            });
        });
    };
    ShowTaskComponent.ctorParameters = function () { return [
        { type: _tasks_api_service__WEBPACK_IMPORTED_MODULE_2__["TasksApiService"] },
...
var TasksComponent = /** @class */ (function () {
    function TasksComponent(_httpService) {
        this._httpService = _httpService;
        this.list = [];
    ...
    TasksComponent.prototype.addFormToggle = function () {
    ...
    TasksComponent.prototype.addTask = function (e) {
        var _this = this;
        // this.addForm = !this.addForm;
        this._httpService.getTasks().subscribe(function (data) {
            _this.tasks = data;
            _this.tasks.tasks[_this.tasks.tasks.length - 1].style = "true";
            _this.allTasks = true;
            var self = _this;
            _this.list = _this.tasks.tasks.slice();
            _this.nodeStylingIndex = _this.tasks.tasks.length - 1;
            _this.nodeStyling = _this.list[_this.list.length - 1];
            _this.nodeStyling.style = "true";
            console.log("Add task list:", _this.list[_this.list.length - 1]);
            setTimeout(function () {
    ...
    TasksComponent.prototype.completedToggle = function (id, e, index) {
        var _this = this;
        this._httpService.updateCompleted(id, { completed: e.target.checked }).subscribe(function (value) {
            _this._httpService.getTasks().subscribe(function (data) {
                _this.tasks = data;
                _this.list = _this.tasks.tasks.slice();
                if (_this.reverse) {
                    _this.list.reverse();
    ...
    TasksComponent.prototype.deleteTask = function (id) {
        ...
        this._httpService.deleteTask(id).subscribe(function (data) {
            _this._httpService.getTasks().subscribe(function (data) {
                _this.tasks = data;
                if (_this.reverse) {
                    _this.list = _this.tasks.tasks.slice();
                    _this.list = _this.list.reverse();
                }
                else {
                    _this.list = _this.tasks.tasks.slice();
                }
    ...
    TasksComponent.prototype.editTask = function (id, i) {
    ...
    TasksComponent.prototype.getTaskById = function (e) {
        var _this = this;
        this.value += e.target.value;
        this._httpService.getById(e).subscribe(function (data) {
            console.log(data);
            _this.thirdTask = data;
        });
    };
    TasksComponent.prototype.hideAdd = function () {
        this.addForm = !this.addForm;
        this.hideAddForm = !this.hideAddForm;
    };
    TasksComponent.prototype.hovering = function (index) {
        if (index == this.nodeStylingIndex) {
            console.log("Hovring", index, this.nodeStylingIndex);
            this.nodeStyling.style = '';
        }
    };
    TasksComponent.prototype.reverseTasks = function () {
    ...
    TasksComponent.prototype.onCompleted = function (event) {
    ...
    TasksComponent.prototype.onUpdateSubmit = function (id) {
        var _this = this;
        var taskInput = {
            title: this.form.get('title').value,
            description: this.form.get('description').value,
        ...
        var task = { title: taskInput.title, description: taskInput.description, completed: taskInput.completed };
        this._httpService.updateTask(id, task).subscribe(function (data) {
            _this._httpService.getTasks().subscribe(function (data) {
                _this.tasks = data;
                _this.list = _this.tasks.tasks.slice();
                _this.list[_this.taskBeingUpdated].style = "true";
                if (_this.reverse) {
                    _this.list = _this.list.reverse();
                }
            });
    ...
    TasksComponent.prototype.ngOnInit = function () {
        ...
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (term) { return _this._httpService.getById(term); }));
    };
    TasksComponent.prototype.onSelect = function (data, i) {
        this.selectedSection = data;
        this.i = i;
    };
    TasksComponent.prototype.pushObjective = function (event, indexValue) {
...
//# sourceMappingURL=project1-project1-module-es5.js.map